...
function Register(props) {
  ...
  const { email, phone, password, country, country_code } = inputs;
  ...
  return (
    <Container component="main" maxWidth="xs">
      <NormalAppBar backlink="/" title="Create an Account" />
...
const mapStateToProps = (state) => ({
  ...
  message: state.login.userdata.message,
...
const mapDispacthToProps = (dispatch) => {
  return {
    register: (email, phone, password, country, country_code, type) =>
      dispatch(register(email, phone, password, country, country_code, type)),
  };
};
